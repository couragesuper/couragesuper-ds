...
if False :
    ...
    url = "http://www.shinechurch.or.kr/%EC%98%88%EB%B0%B0%EC%99%80-%EB%A7%90%EC%94%80/%EC%A3%BC%EB%8B%98%EA%BB%98-%EC%86%8D%EC%96%98%EA%B8%B0/"
    ...
    url_for_page = "http://www.shinechurch.or.kr/%EC%98%88%EB%B0%B0%EC%99%80-%EB%A7%90%EC%94%80/%EC%A3%BC%EB%8B%98%EA%BB%98-%EC%86%8D%EC%96%98%EA%B8%B0/?pageid={page}&mod=list"
    ...
    for i in range(0,len(revlistMissedSermon)) :
        query = "INSERT INTO tUccSermonCTS3( sDate ,url ,title ,biblecontent  ,youtubeURL ,content ,succeed ) VALUES ('{sDate}' ,'{url}' ,'{title}' ,'{biblecontent}'  ,'{youtubeURL}' ,'{content}' ,{succeed})"
        dicData = {}
