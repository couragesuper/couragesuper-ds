...
if False :
    ...
    url = "http://www.shinechurch.or.kr/%ec%98%88%eb%b0%b0%ec%99%80-%eb%a7%90%ec%94%80/%eb%91%90%eb%9e%80%eb%85%b8%ec%84%b1%ea%b2%bd%ea%b5%90%ec%8b%a4/"
    ...
    url_for_page = "http://www.shinechurch.or.kr/%EC%98%88%EB%B0%B0%EC%99%80-%EB%A7%90%EC%94%80/%EB%91%90%EB%9E%80%EB%85%B8%EC%84%B1%EA%B2%BD%EA%B5%90%EC%8B%A4/?pageid={page}&mod=list"
    ...
    for i in range(0,len(revlistMissedSermon)) :
        query = "INSERT INTO tUccSermonCTS( sDate ,url ,title ,biblecontent  ,youtubeURL ,content ,succeed ) VALUES ('{sDate}' ,'{url}' ,'{title}' ,'{biblecontent}'  ,'{youtubeURL}' ,'{content}' ,{succeed})"
        dicData = {}
