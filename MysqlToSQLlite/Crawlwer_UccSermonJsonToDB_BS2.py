...
if False :
    ...
    url = "http://www.shinechurch.or.kr/%EC%98%88%EB%B0%B0%EC%99%80-%EB%A7%90%EC%94%80/%EC%B2%AD%EB%85%84%EB%8F%85%EC%88%98%EB%A6%AC/"
    ...
    url_for_page = "http://www.shinechurch.or.kr/%EC%98%88%EB%B0%B0%EC%99%80-%EB%A7%90%EC%94%80/%EC%B2%AD%EB%85%84%EB%8F%85%EC%88%98%EB%A6%AC/?pageid={page}&mod=list"
    ...
    for i in range(0,len(revlistMissedSermon)) :
        query = "INSERT INTO tUccSermonCTS2( sDate ,url ,title ,biblecontent  ,youtubeURL ,content ,succeed ) VALUES ('{sDate}' ,'{url}' ,'{title}' ,'{biblecontent}'  ,'{youtubeURL}' ,'{content}' ,{succeed})"
        dicData = {}
